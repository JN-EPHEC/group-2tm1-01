...
const AdminOrdersPage: React.FC = () => {
  ...
  useEffect(() => {
    fetch('https://m1-4.ephec-ti.be:5000/api/orders', { credentials: 'include' }) // 👈 Ajout de credentials obligatoire pour l'admin !
      .then(res => res.json())
      .then(data => {
  ...
  const handleStatusChange = (id: number, newStatus: Order['status']) => {
    fetch(`https://m1-4.ephec-ti.be:5000/api/orders/${id}/status`, {
      method: 'PUT',
