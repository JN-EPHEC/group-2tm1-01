    ...
    <div>
      ...
      <div className="row g-4 mb-5">
        ...
        <div className="col-md-4">
          <div className="card h-100 shadow-sm border-0 bg-white">
            <div className="card-body">
              <h3 className="card-title h5 text-dark mb-3">Horaires d'ouverture</h3>
        ...
        <div className="col-md-4">
          <div className="card h-100 shadow-sm border-0 bg-white">
            <div className="card-body">
              <h3 className="card-title h5 text-dark mb-3">Contact</h3>
        ...
        <div className="col-md-4">
          <div className="card h-100 shadow-sm border-0 bg-white">
            <div className="card-body d-flex flex-column">
              <h3 className="card-title h5 text-dark mb-3">Plan d'accès</h3>
